...
def build_trading_node_config(cfg: ArbConfig) -> TradingNodeConfig:
    ...
    return TradingNodeConfig(
        ...
        exec_engine=LiveExecEngineConfig(
            ...
            # #378:ack 仍由 venue 广播式信号驱动(WS PLACEMENT/trade 消息 / CURRENT_BETS 帧)，
            # 但等待阈值收窄为 10s；仍小于 tracking_timeout=60s，确保异常 ACK 能及时进入定向查询。
            inflight_check_threshold_ms=10_000,
