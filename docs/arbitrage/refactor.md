...
| Q20 ✅ | strategy 机会快照隔离:开跑时冻该 pair 的订单簿+持仓+way_rebate(预算冻结),全程用拷贝免受新成交扰动;安全闸走 live;NT 无原生快照故自建;strategy 内部不单独成章。⚠️ venue liveness 安全闸由 Risk 读,Strategy 不读 | §5.4 |
