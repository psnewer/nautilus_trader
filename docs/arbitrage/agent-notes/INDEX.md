...
## 项目进展
- [gap_c_oe_exec_live_validated](gap_c_oe_exec_live_validated.md) — **重要勘误**:`place_and_cancel` 跑老 services 栈、**不验** NT 适配器;NT-native OE Gap C Tier 1(place+cancel 不成交)已于 2026-06-08 live 通过;Tier 2 真成交帧仍待验证。
