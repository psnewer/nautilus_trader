...
"""
直接使用 py_clob_client 获取 Polymarket 数据
"""
...
class PolymarketSimpleAdapter:
    """Polymarket 简化适配器"""
    
    def __init__(self):
        self._log = logging.getLogger('PolymarketSimple')
...
def test_adapter():
    ...
    print('=' * 70)
    print('测试 Polymarket 简化适配器')
    print('=' * 70)
    print()
    
    adapter = PolymarketSimpleAdapter()
